INSERT INTO shampoo_company_db.labels(id, title, subtitle)
...
INSERT INTO shampoo_company_db.ingredients(id, name, price)
VALUES (1, 'Apple', '0.50'),
(2, 'Nettle', '0.70'),
...
INSERT INTO shampoo_company_db.shampoos(id, brand, price, size, label_id)
...
INSERT INTO shampoos_ingredients(shampoos_id, ingredients_id) VALUES
(1, 1), (1, 2), 
(2, 3),
(3, 11), (3, 5), 
(4, 11), (3, 6), 
